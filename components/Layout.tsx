      ...
      {!hideHeaderFooter && (
        <header className="fixed top-0 left-0 right-0 z-50 bg-[#030712]/95 backdrop-blur-md border-b border-white/[0.05]">
          <div className="max-w-7xl mx-auto px-6 h-20 flex items-center justify-center">
            <span className="font-black text-xl tracking-[0.15em] text-white uppercase">Ara AutoFlow</span>
          </div>
        </header>
      )}
          ...
          <div className="max-w-6xl mx-auto px-6">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-24 mb-16">
              <div className="space-y-6">
                ...
                <p className="text-slate-500 leading-relaxed font-medium max-w-sm text-base">
                  High-performance automation systems for enterprise operations. Built on n8n. Secured for scale.
                </p>
              </div>
              <div className="space-y-6">
                <h4 className="text-indigo-500 font-black uppercase tracking-[0.2em] text-[10px]">Support Nexus</h4>
                <div className="space-y-4">
                  <p className="text-slate-400 text-sm font-medium">For project inquiries and technical assistance:</p>
                  <a 
                    href="mailto:arafath1299otm@gmail.com" 
                    className="text-xl font-bold text-white hover:text-indigo-400 transition-colors block"
                  >
            ...
            <div className="pt-12 border-t border-white/[0.05] flex flex-col md:flex-row justify-between items-center gap-6">
              <p className="text-slate-600 text-xs font-medium">
                &copy; {new Date().getFullYear()} Ara AutoFlow. Engineering Operational Excellence.
              </p>
              <div className="flex space-x-8 text-[10px] font-black uppercase tracking-widest text-slate-600">
                <span>Verified n8n Partner</span>
